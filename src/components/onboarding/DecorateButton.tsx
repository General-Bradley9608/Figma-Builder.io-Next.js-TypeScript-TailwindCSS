...
export default function DecorateButton({
  ...
  return (
    <div className={`flex relative flex-col items-${position} w-full max-w-[1019px] max-md:max-w-full`}>
      <button className={`flex z-10 gap-2 justify-end items-end px-5 py-4 mt-40 mr-32 text-base font-medium bg-white bg-opacity-10 min-h-12 rotate-[${angle}] border border-blue-700 dark:border-white rounded-[32px] max-md:mt-10 max-md:mr-2.5`}>
