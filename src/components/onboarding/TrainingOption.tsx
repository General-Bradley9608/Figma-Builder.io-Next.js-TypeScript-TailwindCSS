...
const TrainingOption: React.FC<TrainingOptionProps> = ({
  ...
  return (
    <article className={`flex flex-col px-6 pt-6 pb-2 my-auto rounded-3xl min-h-[290px] min-w-[240px] w-[427px] max-md:px-5 max-md:max-w-full cursor-pointer transition-colors duration-300 ${defaultStyle} ${hoverStyle}`}>
