  ...
  return (
    <div className="flex flex-col mt-6 w-full max-md:max-w-full">
      <div className="flex flex-col w-full max-md:max-w-full">
        <div className="flex flex-col w-full max-md:max-w-full">
          <label htmlFor="shareLink" className="text-sm font-medium leading-none text-accent-foreground">
            Share link
          </label>
          <div className="flex flex-wrap gap-1.5 mt-1.5 w-full text-base max-md:max-w-full">
            <div className="flex flex-1 shrink gap-1.5 text-gray-900 whitespace-nowrap basis-0 min-w-[240px]">
