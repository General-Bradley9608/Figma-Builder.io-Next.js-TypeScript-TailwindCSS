      ...
      <div className="flex flex-col max-w-full w-[416px]">
        <div className="flex flex-col self-center w-full">
          <div className="flex flex-col w-full max-w-[416px]">
            <h1 className="text-3xl font-semibold leading-none text-center text-accent-foreground">
              Reset Your Password
            </h1>
            <p className="gap-1 mt-3 text-center w-full text-sm leading-none text-secondary-foreground">
        ...
        <div className="flex flex-col mt-7 w-full text-base font-semibold">
          ...
          >
            <div className="overflow-hidden px-5 py-2.5 w-full bg-primary rounded-lg shadow-sm min-w-[240px] text-center">
              Reset Password
            </div>
          </button>
          <button
            type="button"
            className="flex items-start mt-2 w-full rounded-lg text-accent-foreground"
          >
            <div className="overflow-hidden px-5 py-2.5 w-full rounded-lg min-w-[240px]">
              Go back
            </div>
          </button>
        </div>
